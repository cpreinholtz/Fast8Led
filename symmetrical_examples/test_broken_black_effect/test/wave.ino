...
void colorWaveChangeAll(int del){
...
void blueWaveStatic(int fundameltalWavelength){
...
void blueWaveTemporal(int fundameltalWavelength, int del){
...
void colorWaveTemporal(int fundameltalWavelength, int del){
...
void blueWaveMovingTemporal(int fundameltalWavelength, int del){
